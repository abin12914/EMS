            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="{{route('excavator.store')}}" method="post" class="form-horizontal" autocomplete="off">
                            <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @else
                                                        <textarea class="form-control" name="description" id="description" rows="1" placeholder="Description" style="resize: none;" tabindex="2"></textarea>
                                                    @endif
                                                    {{-- adding error_message p tag component --}}
