...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row no-print">
            @if(!empty($excavator) && !empty($excavator))
                <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="maker" id="maker" placeholder="Maker" value="{{ old('maker', $excavator->maker) }}" maxlength="100" minlength="3" tabindex="3">
                                                        {{-- adding error_message p tag component --}}
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control decimal_number_only" name="capacity" id="capacity" placeholder="Capacity" value="{{ old('capacity', $excavator->capacity) }}" maxlength="4" minlength="1" tabindex="4">
                                                        {{-- adding error_message p tag component --}}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control decimal_number_only" name="bucket_rate" id="bucket_rate" placeholder="Bucket Rate" value="{{ old('bucket_rate', $excavator->bucket_rate) }}" maxlength="4" minlength="1" tabindex="5">
                                                        {{-- adding error_message p tag component --}}
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control decimal_number_only" name="breaker_rate" id="breaker_rate" placeholder="Breaker Rate" value="{{ old('breaker_rate', $excavator->breaker_rate) }}" maxlength="4" minlength="1" tabindex="6">
                                                        {{-- adding error_message p tag component --}}
            ...
            @else
                <h1 class="text-red">Selected Excavator Not Found! <i class="fa fa-question text-blue" title="Selected excavator record may be deleted or not available to you."></i></h1>
            @endif
        </div>
        <!-- /.row (main row) -->
    </section>
