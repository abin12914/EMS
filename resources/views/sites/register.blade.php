...
<div class="content-wrapper">
     <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('site.index') }}"> Site</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="{{route('site.store')}}" method="post" class="form-horizontal" autocomplete="off">
                            <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="{{ old('name') }}" maxlength="100" tabindex="1">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="place" id="place" placeholder="Place" value="{{ old('place') }}" maxlength="100" minlength="3" tabindex="2">
                                                    {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    @else
                                                        <textarea class="form-control" name="address" id="address" rows="1" placeholder="Address" style="resize: none;" tabindex="3"></textarea>
                                                    @endif
                                                    {{-- adding error_message p tag component --}}
                                                    ...
                                                    <select class="form-control select2" name="site_type" id="site_type" tabindex="4">
                                                        ...
                                                        @if(!empty($siteTypes))
                                                            @foreach($siteTypes as $key => $siteType)
                                                                <option value="{{ $key }}" {{ old('site_type') == $key ? 'selected' : '' }}>{{ $siteType }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                    {{-- adding error_message p tag component --}}
