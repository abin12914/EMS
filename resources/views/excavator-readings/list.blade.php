                                        ...
                                        @if(!empty($excavatorReadings))
                                            @foreach($excavatorReadings as $index => $excavatorReading)
                                                <tr>
                                                    ...
                                                    <td>{{ $excavatorReading->transaction->transaction_date->format('d-m-Y') }}</td>
                                                    <td>{{ $excavatorReading->employee->account->name }}</td>
                                                    <td>{{ $excavatorReading->from_date->format('d-m-Y'). " - ". $excavatorReading->to_date->format('d-m-Y') }}</td>
