...
class SiteController extends Controller
{
    ...
    public function store(
        ...
        try {
            ...
            return redirect(route('site.index'))->with("message","Site details saved successfully. Reference Number : ". $siteResponse['site']->id)->with("alert-class", "success");
        } catch (Exception $e) {
    ...
    public function update(
        ...
        if($updateResponse['flag']) {
            return redirect(route('site.index'))->with("message","Sites details updated successfully. Updated Record Number : ". $updateResponse['site']->id)->with("alert-class", "success");
        }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect(route('site.index'))->with("message","Site details deleted successfully.")->with("alert-class", "success");
        } catch (Exception $e) {
            //roll back in case of exceptions
            DB::rollback();
