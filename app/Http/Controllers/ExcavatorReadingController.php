...
class ExcavatorReadingController extends Controller
{
    ...
    {
        return view('excavatorReadings.register');
    }
    ...
    public function store(
        ...
        try {
            ...
            $excavatorReading     = $excavatorReadingRepo->getExcavatorReading($id, [], false);
            ...
            return redirect(route('excavatorReading.index'))->with("message","ExcavatorReading details saved successfully. Reference Number : ". $transactionResponse['excavatorReading'])->with("alert-class", "success");
        } catch (Exception $e) {
    ...
    public function show($id)
    {
        ...
        return view('excavatorReadings.details', [
    ...
    public function edit($id)
    {
        ...
        return view('excavatorReadings.edit', [
            'excavatorReading' => $excavatorReading,
        ]);
    }
